...
introns <- psetdiff(metxgr, metxgrl) ## voila, introns for every multi-exon transcript
##
...
newjx <- rowRanges(rsejx)
newjx
## let's pretend they are not annotated yet
mcols(newjx) <- NULL ## remove metadata
...
## create a GRangesList with exons
unktxl <- split(unktx, unktx$transcript_id) 
## findOverlaps between GRangesList objects - parent level reporting
